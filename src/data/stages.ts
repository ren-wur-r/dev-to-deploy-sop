...
export const stages: Stage[] = [
    ...
    tabs: [
      ...
      },
      {
        ...
        content: {
          kind: 'git',
          branches: [
            { name: 'main', color: '#c00', env: 'Production', desc: '禁止直接 push / 需 Reviewer 核准 / Tag 觸發 Prod 部署' },
  ...
  },
  {
    ...
    title: 'Production',
    owner: ['MIS'],
    note: 'Production 部署僅限 MIS 操作。RD 可發起請求，不可直接操作正式環境。',
    tabs: [
      {
        id: 'flow',
        label: '流程',
        content: {
          ...
          steps: [
            { title: 'RD 發 MR 至 main', badges: ['RD'], desc: '附：Stage 結果、滲透測試報告、Rollback 計畫' },
            { title: 'MIS 審核並合併', badges: ['MIS'], desc: '確認交付物完整、部署時段' },
            { title: '建立 Release Tag', badges: ['MIS'], desc: 'v1.2.3，觸發 Production Pipeline' },
            { title: 'Pipeline 建置', badges: ['自動'], desc: 'Re-build → Re-scan → Push → 暫停等待核准' },
            { title: 'MIS 核准部署', badges: ['MIS'], desc: 'DB Migration → Deploy → Health Check（失敗自動 Rollback）' },
      ...
      },
      {
        ...
        content: {
          ...
          rows: [
            ...
            { num: '4', item: 'Rollback 計畫 MIS 確認', owner: ['RD', 'MIS'], standard: 'Approved' },
            ...
            { num: '8', item: 'Pipeline Re-build + Re-scan', owner: ['自動'], standard: '0 Critical/High' },
            { num: '9', item: 'MIS 手動核准', owner: ['MIS'], standard: 'CI 記錄' },
      ...
      },
      {
        ...
        content: {
          ...
          steps: [
            ...
            { title: 'MR to main [HOTFIX]', badges: ['RD'], desc: '1 人快速審核' },
            { title: 'MIS 建 Patch Tag', badges: ['MIS'], desc: 'v1.2.4' },
            { title: 'Pipeline → MIS 核准 → 部署', badges: ['MIS'], desc: '' },
